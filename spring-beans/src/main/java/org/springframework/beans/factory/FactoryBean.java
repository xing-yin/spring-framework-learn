 ...
 * interface allows for exposing more fine-grained behavioral metadata(细粒度的行为元数据).
 *
...
public interface FactoryBean<T> {
	 ...
	 * <p>这允许您在不实例化对象的情况下（例如在自动装配时）检查特定类型的bean。
	 * <p>对于正在创建单例对象的实现，此方法应尽量避免创建单例。它应该提前预估类型。
	 * 对于原型，建议在此处返回有意义的类型。
